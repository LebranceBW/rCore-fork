use super::address::{VirtPageNum, VirtAddr, VPNRange, StepByOne, PhysPageNum};
use crate::config::*;
use log::info;
use super::page_table::PTEFlags;
use super::mem_alloc::alloc;
use super::mem_alloc::MemFrame;
...
pub struct MapArea {
    vpn_range: VPNRange,
    data_frames: BTreeMap<VirtPageNum, MemFrame>,
    map_type: MapType,
